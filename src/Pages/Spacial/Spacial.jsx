...
const Spacial = () => {
	const { special } = useContext(DataContext);

	return (
		<section className="curriculum-page">
			<div className="bg-accent p-12 my-10 shadow-xl">
				<h1 className="text-4xl font-bold text-center text-white">Special</h1>
			...
			<div className="container mx-auto space-y-6">
				...
				<div className="text-xl text-center">
					Curriculums Found : {special.length} in Special.
				</div>
