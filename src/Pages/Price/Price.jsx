...
const Price = () => {
    const { sortPrice } = useContext(DataContext);

	return (
		<section className="curriculum-page">
			<div className="bg-accent p-12 my-10 shadow-xl">
				<h1 className="text-4xl font-bold text-center text-white">price</h1>
