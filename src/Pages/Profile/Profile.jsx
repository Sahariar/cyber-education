...
const Profile = () => {
	...
	const handleUpdateProfileSubmission = (event) =>{

		event.preventDefault();
		const form = event.target;
		const fullDisplayName = form.fullName.value;
		const updateDisplayPhoto = form.photoUrl.value;
		
		console.log(fullDisplayName , updateDisplayPhoto);
		userProfileUpdate(fullDisplayName , updateDisplayPhoto)
		.then(() => {
			// Profile updated!
			// ...
						...
						<div className=" m-6 flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-blue-50 text-accent">
							...
							<div className="space-y-4 text-center divide-y divide-gray-700">
								<div className="my-2 space-y-1">
									...
									<p className="px-5 text-xs sm:text-base text-accent-focus">
										Student of Cyber Edu
									</p>
								</div>
									...
									<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
										<div className="col-span-full sm:col-span-3">
											...
											<input
												...
												className="w-full input bg-white  rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 dark:text-accent"
											/>
										</div>
										...
										<div className="col-span-full sm:col-span-3">
											...
											<input
												...
												className="w-full input bg-white rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 dark:text-gray-900"
										...
										<div className="submit-area col-span-full">
											<button
												type="submit"
												className="w-full px-8 py-3 font-semibold rounded-md btn-primary mx-auto"
											>
												Update Profile
											</button>
										</div>
