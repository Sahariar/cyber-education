...
const NewsLetter = () => {
    return (
        <section className="w-full bg-gradient-to-r from-info to-red-100 py-20">
        <div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
            ...
            <div className="flex flex-row">
                ...
                <button type="button" className="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 btn btn-secondary">Subscribe</button>
            </div>
        </div>
    </section>
    );
